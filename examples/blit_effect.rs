use nogine::{graphics::{Graphics, pipeline::{RenderPipeline, RenderTexture, SceneRenderData, DEFAULT_RENDER_TARGET}, RenderStats, shader::Shader, texture::TextureFiltering, BlendingMode, material::Material}, window::{WindowCfg, WindowMode}, color::{Color4, Color}, math::vec2, unwrap_res};
